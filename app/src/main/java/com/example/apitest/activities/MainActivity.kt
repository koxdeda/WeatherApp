...
import com.example.apitest.utils.Constants
import com.example.apitest.R
import com.example.apitest.databinding.ActivityMainBinding
import com.example.apitest.models.WeatherResponse
import com.example.apitest.network.WeatherService
    ...
    private fun setupUI(){
        ...
        if(!weatherResponseJsonString.isNullOrEmpty()){
            ...
            for(i in weatherList.weather.indices){
                ...
                binding?.tvMin!!.text = weatherList.main.temp_max.toString() + "max"
                ...
                setUpWeatherIcon(weatherList.weather[i].icon)
            }
        }
        }

    private fun setUpWeatherIcon(responseImageCode: String){
        when(responseImageCode){
